                  ...
                  (
                    ...
                    <div className='jos' key={`portfolio-${index}`}>
                      <div className='group'>
                        ...
                        <div className='mt-8'>
                          <div className='mb-3 flex flex-wrap gap-2 text-xl leading-[1.33] -tracking-[0.5px] text-ColorBlack group-hover:text-ColorYellow lg:flex-nowrap xl:text-2xl'>
                            <a
                            ...
                            <a
                              href={`portfolio/${slug(title)}`}
                              className='hover:text-ColorYellow'>
                              {category}
                            </a>
                          </div>
