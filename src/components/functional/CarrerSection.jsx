          ...
          {data?.map(
            ({
              ...
              <div class='jos' data-jos_delay='0.3'>
                <div class='group rounded-[10px] border border-[#E6E6E6] bg-white p-[30px] transition-all duration-300 hover:border-ColorOffWhite hover:bg-ColorYellow/5 md:p-10'>
                  ...
                  <a
                    ...
                    class='inline-flex items-center gap-x-2 text-base font-bold text-ColorBlack group-hover:text-ColorYellow'>
                    Apply now
